<template>
  <div class="video-keyframes-view">
    <!-- 页面头部 -->
    <a-page-header
      class="page-header"
      :title="pageTitle"
...
import VideoKeyframes from '../components/VideoKeyframes.vue'
...
const pageTitle = computed(() => {
  return video.value ? `关键帧 - ${video.value.title}` : '关键帧'
})
const pageSubtitle = computed(() => {
  return video.value ? '查看和管理视频关键帧' : '加载中...'
})
